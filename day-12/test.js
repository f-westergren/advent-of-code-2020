 ...
 * 3. (-y, x)       // Cancel the double negative
 *
...
console.log(manhattan([0, 0], [300, 300]));
...
let p1_map = new Map({ directions: input, useWaypoint: false });
p1_map.run();
let p1_distance = p1_map.getDistanceFromCurrentLocationTo(0, 0);
console.log("Part One:", p1_distance);

let p2_map = new Map({ directions: input, useWaypoint: true });
p2_map.run();
let p2_distance = p2_map.getDistanceFromCurrentLocationTo(0, 0);
console.log("Part Two:", p2_distance);
